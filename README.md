...
3. Tutorial John the ripper --> Check Module 6 John the ripper
4. Tutorial Hydra: https://www.freecodecamp.org/news/how-to-use-hydra-pentesting-tutorial/
5. Hydra usage examples --> Module 13 Hacking Web Servers; Lab 2; Task 1
6. Hydra against ssh --> https://labex.io/tutorials/hydra-brute-force-ssh-in-hydra-549926
7. CEH Engage Walkthrough --> https://github.com/3ls3if/Cybersecurity-Notes/tree/main/readme/ceh-engage-walkthrough
8. nmap cheat sheet: https://hackertarget.com/nmap-cheatsheet-a-quick-reference-guide/; https://github.com/jasonniebauer/Nmap-Cheatsheet
9. Sniffing of Login Credential or Password Capturing in Wireshark --> https://www.geeksforgeeks.org/ethical-hacking/sniffing-of-login-credential-or-password-capturing-in-wireshark/
10. Sebelum menggunakan nmap untuk scanning specific IP, cek dulu port yang terbuka dengan command: nmap IP/subnet, contoh: nmap 192.168.1.0/24
11. Contoh penggunaan nmap: nmap -Pn -p445 -A [IP]
12. Cara mencari versi IMAP dengan nmap: nmap -Pn -p143 -A [IP]
13. cara menggunakan hydra untuk bruteforce: hydra -L user.txt -P pass.txt rdp://IP
14. mencari device mobile yang ada di subnet tertentu: search for IP that open port 5555; ADB --> ADB shell to connect to device and ADB pull to download the file (https://docs.ubports.com/en/latest/userguide/advanceduse/adb.html) atau menggunakan phonesploit module 17 (Hacking Mobile Platforms)
15. Cara menggunakan OpenVAS: login to OpenVAS and do the following --> module 5: Vulnerability analysis
