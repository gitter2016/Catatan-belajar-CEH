...
5. Sebelum menggunakan nmap untuk scanning specific IP, cek dulu port yang terbuka dengan command: nmap IP/subnet, contoh: nmap 192.168.1.0/24
6. Contoh penggunaan nmap: nmap -Pn -p445 -A [IP]
7. Cara mencari versi IMAP dengan nmap: nmap -Pn -p143 -A [IP]
...
10. Cara menggunakan OpenVAS: login to OpenVAS and do the following --> module 5: Vulnerability analysis
